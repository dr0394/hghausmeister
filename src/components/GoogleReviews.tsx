      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-2xl font-bold text-gray-800">Bewertungen</span>
          </div>
          ...
          <p className="text-gray-600">Basierend auf 24 Bewertungen</p>
        </div>

        <div className="grid md:grid-cols-2 gap-6">
          {reviews.map((review, index) => (
            <div key={index} className="bg-gray-50 border-2 border-gray-200 p-6 hover:border-[#10b981] transition-all hover:shadow-lg">
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h4 className="font-semibold text-[#1e3a5f]">{review.name}</h4>
              ...
              <div className="flex mb-3">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    key={star}
                    className={`w-4 h-4 ${
                      star <= review.rating ? 'fill-[#FBBC04] text-[#FBBC04]' : 'text-gray-300'
                    }`}
                  />
                ))}
              </div>
